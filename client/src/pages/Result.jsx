    ...
    <div className='mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]'>
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        {resultImage && <div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
          <div>
              <input onChange={e=>removeBg(e.target.files[0])} accept='image/*' type="file" name='' id='upload2' hidden />
                <label htmlFor="upload2">
                    <p className='px-8 py-2.5 text-violet-600 text-sm border border-violet-600 rounded-full hover:scale-105 transition-all duration-700'>Try another image</p>
                </label>
          </div>
