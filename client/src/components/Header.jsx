        ...
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div >
                ...
                <p className='my-6 text-[15px] text-gray-500' >
                    Lorem lpnum is simply dummy text of the printing and typesetting industry. <br className='max-sm:hidden' /> Lorem Lpsum has been the industry's standard dummy text ever.
                    </p>
                <div>
                    <input onChange={e=>removeBg(e.target.files[0])} accept='image/*' type="file" name='' id='upload1' hidden />
